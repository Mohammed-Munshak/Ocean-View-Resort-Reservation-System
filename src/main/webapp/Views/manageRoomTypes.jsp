...
<head>
  ...
  <title>Manage Room Types | Ocean View Resort</title>
...
<div class="container">
  ...
  <div class="card">
    <h3><i class="fas fa-plus-circle"></i> Add New Room Category</h3>
    
    <form method="post" action="<%= request.getContextPath() %>/admin/roomtypes">
      <input type="hidden" name="action" value="add" />
      
      <div class="form-grid">
        <div class="form-group">
          <label>Type Name</label>
          <input type="text" name="typeName" placeholder="e.g. Deluxe Suite" required />
        </div>
        
        <div class="form-group">
          <label>Rate Per Night (LKR)</label>
          <input type="number" name="ratePerNight" step="0.01" placeholder="0.00" required />
        </div>

        <div class="form-group">
          <label>Description</label>
          <input type="text" name="description" placeholder="Short description of amenities" />
        </div>
  ...
  <div class="card">
    <h3><i class="fas fa-list-ul"></i> Room Categories & Rates</h3>
      ...
      <table>
        <thead>
          <tr>
            ...
            <th width="14%">Current Rate</th>
            <th width="10%">Active</th>
            <th width="14%">Update Price</th>
        ...
        <tbody>
          <% if (roomTypes != null && !roomTypes.isEmpty()) {
            ...
            <tr>
              <td data-label="ID">#<%= rt.getRoomTypeId() %></td>
              <td data-label="Name"><strong><%= rt.getTypeName() %></strong></td>
              <td data-label="Description"><%= (rt.getDescription() == null ? "-" : rt.getDescription()) %></td>
              <td data-label="Current Rate"><span class="rate-display">LKR <%= rt.getRatePerNight() %></span></td>
              ...
              <td data-label="Update Price">
                <form method="post" action="<%= request.getContextPath() %>/admin/roomtypes" class="inline-form">
                  <input type="hidden" name="action" value="updateRate" />
                  <input type="hidden" name="roomTypeId" value="<%= rt.getRoomTypeId() %>" />
                  
                  <input type="number" name="newRate" step="0.01" required 
                         placeholder="<%= rt.getRatePerNight() %>" class="input-small" />
                  
                  <button type="submit" class="btn-update" title="Save New Rate">
              ...
              <td data-label="Action">
                <form method="post" action="<%= request.getContextPath() %>/admin/roomtypes" style="margin:0;">
                  <input type="hidden" name="action" value="toggle" />
                  <input type="hidden" name="roomTypeId" value="<%= rt.getRoomTypeId() %>" />
                  <input type="hidden" name="newActive" value="<%= rt.getIsActive() == 1 ? 0 : 1 %>" />
