...
<div class="container">
  ...
  <div class="header-row">
    <h2><i class="fas fa-tags"></i> Room Types & Prices</h2>
  ...
  <div class="card">
    <h3><i class="fas fa-list-ul"></i> Existing Categories</h3>
    ...
    <div class="table-responsive">
      <table>
        ...
        <tbody>
            ...
            <tr>
              ...
              <td>
                <form method="post" action="<%= request.getContextPath() %>/admin/roomtypes" style="margin:0;">
                  ...
                  <% if (rt.getIsActive() == 1) { %>
                    <button type="submit" class="btn-toggle btn-deactivate">Deactivate</button>
                  <% } else { %>
                    <button type="submit" class="btn-toggle btn-activate">Activate</button>
                  <% } %>
                </form>
              </td>
            </tr>
          <% } } else { %>
            <tr>
              <td colspan="7" style="text-align:center; padding: 20px;">No room types defined yet.</td>
            </tr>
          <% } %>
        </tbody>
      </table>
