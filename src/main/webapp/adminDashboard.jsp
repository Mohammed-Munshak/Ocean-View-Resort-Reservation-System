...
<body>
  ...
  <div class="header">
    ...
    <div class="user-profile">
      <span><i class="fas fa-user-shield"></i> <%= session.getAttribute("fullName") %></span>
      <span>|</span>
  ...
  <div class="container">
    ...
    <p class="welcome-text">Manage your hotel staff, rooms, and system configurations.</p>
    ...
    <div class="grid">
      ...
      <a href="<%= request.getContextPath() %>/admin/roomtypes" class="card">
        ...
        <p>Set Types & Rates for Resort</p>
      </a>
